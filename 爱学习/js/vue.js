...
/*弹窗组件  确认事件名：confirmCancel   显示/隐藏:isShowConfirm */
Vue.component('v-confirm', {
  props: ['title','isshow'],
  template: '<div class="search-toast" v-show="isshow">\
  	<div class="black-floor"></div>\
  	<div class="ground-toast">\
  		<div class="toast-content">{{title}}</div>\
		<div class="toast-btn">\
			<a id="searchland7" class="no" v-on:click="cancel">取消</a>\
			<a id="searchland8" class="sure" v-on:click="confirm">确定</a>\
		</div>\
		</div>\
	</div>',
   data: function () {
